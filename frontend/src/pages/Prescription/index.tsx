    ...
    <div>
      ...
      <div className="mt-14 pb-8 flex">
        <div className="bg-cyan-500 py-4 px-10 my-auto ml-10 rounded-2xl">
          ...
          <Button className="group relative w-64 flex justify-center rounded-lg border border-transparent bg-black py-2 mb-20 mt-8 text-sm font-medium text-white hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Novo medicamento</Button>
        </div>
